  ...
  return (
    <div className="w-full relative overflow-hidden h-[100vh]">
      ...
      <div className="absolute inset-0 backdrop-blur-md bg-black/20 flex flex-col items-center justify-center px-4 text-center">
        ...
        <TextGenerateEffect
          className="text-white text-3xl sm:text-4xl md:text-5xl font-bold drop-shadow-lg leading-tight"
          words="Search your favorite recipe"
        />

        <TextGenerateEffect
          className="text-white/90 text-lg pt-5 md:text-xl font-light mb-6 max-w-2xl mx-auto text-center leading-relaxed"
          words="From quick meals to global flavors — inspiration for every moment, just one click away."
        />
